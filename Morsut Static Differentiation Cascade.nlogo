...
to transcribe-proteins
  ...
  ask receiver-nucleus-breed [
    ...
    set anti-GFP-notch-transcription-rate (anti-GFP-initial-rate + cleaved-nuc-anti-GFP-notch-count-value)
    set anti-CD19-notch-transcription-rate (anti-CD19-initial-rate)
    set CD19-delta-transcription-rate (cleaved-nuc-anti-GFP-notch-count-value * 100)
    set BFP-transcription-rate (cleaved-nuc-anti-CD19-notch-count-value * 100)
    ...
    ;; transcribe delta proteins
    if CD19-delta-transcription-rate >= random 10000 [
    ...
    if BFP-transcription-rate >= random 10000 [
