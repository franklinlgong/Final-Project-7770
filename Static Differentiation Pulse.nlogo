...
globals [
  ...
  anti-BFP-notch-transcription-rate

  GFP-repressor-transcription-rate
  CD19-repressor-transcription-rate
  BFP-repressor-transcription-rate
...
receiver-nucleus-breed-own [
  ...
  cleaved-nuc-anti-BFP-notch-count-value

  GFP-repressor-count-value
  CD19-repressor-count-value
  BFP-repressor-count-value
...
;;=====================================================================
;; the BFP delta diffusing on the membrane in active form

breed [BFP-delta-mem-prime-breed   BFP-delta-mem-prime]

BFP-delta-mem-prime-breed-own [
  birth       ;-- the tick that the original delta was created
  local-lipid ;-- the lipid that the membrane delta prime is associated with
  parent      ;-- owning nucleus
  parent-who  ;-- owning nucleus id
...
;;=====================================================================
;; recently transcribed anti-BFP notch transporting to membrane

breed [anti-BFP-notch-breed      anti-BFP-notch]

anti-BFP-notch-breed-own [
  birth      ;-- the tick that the notch was created
  parent     ;-- owning nucleus
  parent-who ;-- owning nucleus id
]
...
;;=====================================================================
;; anti-BFP-notch that is diffusing on membrane

breed [anti-BFP-notch-mem-breed  anti-BFP-notch-mem]

anti-BFP-notch-mem-breed-own [
  birth       ;-- the tick that the original notch was created
  parent      ;-- owning nucleus
  parent-who  ;-- owning nucleus id
  local-lipid ;-- the lipid that the membrane notch is associated with
...
;;=====================================================================
;; diffusing cleaved anti-BFP-notch

breed [anti-BFP-cleaved-notch-breed  anti-BFP-cleaved-notch]

anti-BFP-cleaved-notch-breed-own [
  birth       ;-- the tick that the original notch was created
  parent      ;-- owning nucleus
  parent-who  ;-- owning nucleus id
  time-cleaved;-- time the protein was cleaved and sent to nucleus
...
;;=====================================================================
;; cleaved anti-BFP-notch that has reached nucleus and modulating transcription

breed [anti-BFP-notch-nuc-breed  anti-BFP-nucleus-notch]

anti-BFP-notch-nuc-breed-own [
  birth       ;-- the tick that the original notch was created
  parent      ;-- owning nucleus
  parent-who  ;-- owning nucleus id
  time-cleaved;-- time the protein was cleaved and sent to nucleus
...
;;=====================================================================
;; Repressor of GFP induced by anti-CD19-notch cleavage

breed [GFP-repressor-breed       GFP-repressor]

GFP-repressor-breed-own [
  birth      ;-- the tick that the delta was created
  parent     ;-- owning nucleus
  parent-who ;-- owning nucleus id
]
...
;;=====================================================================
;; repressor of CD19 induced by anti-BFP-notch cleavage

breed [CD19-repressor-breed       CD19-repressor]

CD19-repressor-breed-own [
  birth      ;-- the tick that the delta was created
  parent     ;-- owning nucleus
  parent-who ;-- owning nucleus id
]
...
;;=====================================================================
;; Repressor of BFP induced by anti-GFP-notch cleavage

breed [BFP-repressor-breed       BFP-repressor]

BFP-repressor-breed-own [
  birth      ;-- the tick that the delta was created
  parent     ;-- owning nucleus
  parent-who ;-- owning nucleus id
]
...
to setup
  ...
  set anti-BFP-notch-transcription-rate anti-BFP-initial-rate
  ;;--------------------------------------------------
...
to age-out-proteins
  ...
  ask BFP-delta-mem-prime-breed  with [ticks > ( birth + deltaAge )] [ die ]
  ...
  ask CD19-delta-breed            with [ticks > ( birth + deltaAge )] [ die ]
  ask CD19-delta-mem-breed        with [ticks > ( birth + deltaAge )] [ die ]
  ask CD19-delta-mem-prime-breed  with [ticks > ( birth + deltaAge )] [ die ]
  ...
  ask anti-BFP-notch-breed            with [ticks > ( birth + notchAge )] [ die ]
  ask anti-BFP-notch-mem-breed        with [ticks > ( birth + notchAge )] [ die ]
  ...
  ask anti-BFP-cleaved-notch-breed    with [ticks > ( birth + notchAge )] [ die ]
  ...
  ask anti-BFP-notch-nuc-breed        with [ticks > ( birth + notchAge )] [

    ask parent [
      set cleaved-nuc-anti-BFP-notch-count-value ( cleaved-nuc-anti-BFP-notch-count-value - 1 )
    ]

    die
  ]

  ask CD19-repressor-breed        with [ticks > ( birth + notchAge )] [

    ask parent [
      set CD19-repressor-count-value ( CD19-repressor-count-value - 1 )
    ]

    die
  ]
  ask GFP-repressor-breed        with [ticks > ( birth + notchAge )] [

    ask parent [
      set GFP-repressor-count-value ( GFP-repressor-count-value - 1 )
    ]

    die
  ]
  ask BFP-repressor-breed        with [ticks > ( birth + notchAge )] [

    ask parent [
      set BFP-repressor-count-value ( BFP-repressor-count-value - 1 )
    ]
...
to transcribe-proteins
  ...
  ask sender-nucleus-breed [
    ...
    set GFP-delta-transcription-rate (GFP-delta-initial-rate - GFP-repressor-count-value * GFP-Repression)
    set anti-CD19-notch-transcription-rate (anti-CD19-initial-rate + cleaved-nuc-anti-CD19-notch-count-value)
    set GFP-repressor-transcription-rate(cleaved-nuc-anti-CD19-notch-count-value)

    ;; transcribe delta proteins
    if GFP-delta-transcription-rate >= random 100 [
      hatch-GFP-delta-breed 1 [
        set birth      ticks
    ...
    if anti-CD19-notch-transcription-rate >= random 100 [
      hatch-anti-CD19-notch-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      white
        set shape      "diffuser1"
    ...
    if GFP-repressor-transcription-rate - 1 >= random 100 [
      hatch-GFP-repressor-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      white
        set shape      "triangle"
        ...
        set parent-who [who] of myself
        forward (radius * 0.2)
        ask parent [set GFP-repressor-count-value(GFP-repressor-count-value + 1)]
      ]
    ]
  ]
  ...
  ask receiver-nucleus-breed [
    ...
    set CD19-delta-transcription-rate (cleaved-nuc-anti-GFP-notch-count-value - CD19-repressor-count-value * CD19-Repression)
    set BFP-transcription-rate (cleaved-nuc-anti-CD19-notch-count-value - BFP-repressor-count-value * BFP-Repression)
    set GFP-delta-transcription-rate (cleaved-nuc-anti-BFP-notch-count-value - GFP-repressor-count-value * GFP-Repression)

    set GFP-repressor-transcription-rate(cleaved-nuc-anti-CD19-notch-count-value)
    set CD19-repressor-transcription-rate(cleaved-nuc-anti-BFP-notch-count-value)
    set BFP-repressor-transcription-rate(cleaved-nuc-anti-GFP-notch-count-value)

    ;; transcribe notch proteins
    if anti-GFP-notch-transcription-rate >= random 100 [
      hatch-anti-GFP-notch-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      gray
        set shape      "diffuser1"
    ...
    if anti-BFP-notch-transcription-rate >= random 100 [
      hatch-anti-BFP-notch-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      brown
        set shape      "diffuser1"
    ...
    ;; transcribe delta proteins
    if CD19-delta-transcription-rate - 1 >= random 100 [
      hatch-CD19-delta-breed 1 [
        set birth      ticks
        set heading    (random 360)
        set color      red
        set shape      "diffuser1"
    ...
    if BFP-transcription-rate - 1 >= random 100 [
      hatch-BFP-delta-breed 1 [
        set birth      ticks
        set heading    (random 360)
        set color      blue
        set shape      "diffuser1"
    ...
    if GFP-delta-transcription-rate - 1 >= random 100 [
      hatch-GFP-delta-breed 1 [
        set birth      ticks
        set heading    (random 360)
        set color      green
    ...
    if CD19-repressor-transcription-rate - 1 >= random 100 [
      hatch-CD19-repressor-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      white
        set shape      "triangle"
        ...
        set parent-who [who] of myself
        forward (radius * 0.2)
        ask parent [set CD19-repressor-count-value(CD19-repressor-count-value + 1)]
      ]
    ]
    if BFP-repressor-transcription-rate - 1 >= random 100 [
      hatch-BFP-repressor-breed 1 [
        set birth ticks
        set heading    (random 360)
        set color      white
        set shape      "triangle"
        ...
        set parent-who [who] of myself
        forward (radius * 0.2)
        ask parent [set BFP-repressor-count-value(BFP-repressor-count-value + 1)]
      ]
    ]
  ]
end
...
to transform-proteins
  ...
  ask lipid-breed [
    ...
    ask anti-BFP-notch-breed in-radius (lipid-distance / 1) [

      set breed          anti-BFP-notch-mem-breed
      set xcor           [xcor] of myself
      set ycor           [ycor] of myself
      set heading        [heading] of myself
      set shape          "diffuser2"
  ...
  ifelse delta-transform-time = 0 [
    ...
    ask BFP-delta-mem-breed [
      set breed BFP-delta-mem-prime-breed
      set color blue
    ]
  ...
  ask anti-BFP-cleaved-notch-breed with [time-cleaved + indCleavedDiffTime < ticks] [

    set heading towards parent

    forward (distance parent) - (unitMove * centersomeSize) + 3

    set breed          anti-BFP-notch-nuc-breed
  ...
  ask anti-BFP-notch-mem-breed [ set protected false ]
 ...
 ask CD19-delta-mem-breed [
  ...
  set protection nobody
  set ind-to-protect nobody
  ...
  ask BFP-delta-mem-breed [
    ...
    ask local-lipid [
         ...
         set ind-to-protect (protection with [breed = anti-BFP-notch-mem-breed and protected = false])
  ...
  ask GFP-delta-mem-breed [
    ...
    ask local-lipid [
         ...
         set ind-to-protect (protection with [breed = anti-GFP-notch-mem-breed and protected = false])
  ...
  ask CD19-delta-mem-prime-breed [
    ...
    ask local-lipid [
      ...
      if border-region != 0 [
         ...
         set ind-to-cleave one-of region-set with [breed = anti-CD19-notch-mem-breed and protected = false]
    ...
    if cntr > 1 [
      print (word "number of cleaved anti-CD19-notch is " cntr)
    ]
  ]
  ...
  ask BFP-delta-mem-prime-breed [
    ...
    ask local-lipid [
      ...
      if border-region != 0 [
         ...
         set ind-to-cleave one-of region-set with [breed = anti-BFP-notch-mem-breed and protected = false]
         ...
         if ind-to-cleave != nobody [
           ...
           ask ind-to-cleave [
             set breed           anti-BFP-cleaved-notch-breed
             set shape           "square"
             set color           green
             set heading towards parent
...
true
0
Rectangle -1184463 true false 120 45 180 255
